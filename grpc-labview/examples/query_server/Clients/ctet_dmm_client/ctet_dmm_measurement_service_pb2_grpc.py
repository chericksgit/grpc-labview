...
class MeasurementServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PerformDMMVoltageMeasurement = channel.unary_unary(
                ...
                request_serializer=ctet__dmm__measurement__service__pb2.DMMVoltageRequest.SerializeToString,
                response_deserializer=ctet__dmm__measurement__service__pb2.DMMVoltageData.FromString,
                )
...
def add_MeasurementServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PerformDMMVoltageMeasurement': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=ctet__dmm__measurement__service__pb2.DMMVoltageRequest.FromString,
                    response_serializer=ctet__dmm__measurement__service__pb2.DMMVoltageData.SerializeToString,
            ),
...
class MeasurementService(object):
    ...
    def PerformDMMVoltageMeasurement(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/measurementservice.MeasurementService/PerformDMMVoltageMeasurement',
            ctet__dmm__measurement__service__pb2.DMMVoltageRequest.SerializeToString,
            ctet__dmm__measurement__service__pb2.DMMVoltageData.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
