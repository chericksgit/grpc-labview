...
# source: ctet_dio_measurement_service.proto
...
_READDIREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='DISessionName', full_name='measurementservice.ReadDIRequest.DISessionName', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='DISubscribeInterval', full_name='measurementservice.ReadDIRequest.DISubscribeInterval', index=1,
...
_READDIRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='DISessionName', full_name='measurementservice.ReadDIResponse.DISessionName', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STOPDIREQUEST = _descriptor.Descriptor(
  name='StopDIRequest',
  full_name='measurementservice.StopDIRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='DISessionName', full_name='measurementservice.StopDIRequest.DISessionName', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STOPDIRESPONSE = _descriptor.Descriptor(
  name='StopDIResponse',
  full_name='measurementservice.StopDIResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='DISessionName', full_name='measurementservice.StopDIResponse.DISessionName', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='error', full_name='measurementservice.StopDIResponse.error', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WRITEDOREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='DOSessionName', full_name='measurementservice.WriteDORequest.DOSessionName', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WRITEDORESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='DOSessionName', full_name='measurementservice.WriteDOResponse.DOSessionName', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='DOData', full_name='measurementservice.WriteDOResponse.DOData', index=1,
      number=2, type=8, cpp_type=7, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='error', full_name='measurementservice.WriteDOResponse.error', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STOPDIRESPONSE.fields_by_name['error'].message_type = _ERROROUT
...
DESCRIPTOR.message_types_by_name['StopDIRequest'] = _STOPDIREQUEST
DESCRIPTOR.message_types_by_name['StopDIResponse'] = _STOPDIRESPONSE
...
ErrorOut = _reflection.GeneratedProtocolMessageType('ErrorOut', (_message.Message,), {
  ...
  '__module__' : 'ctet_dio_measurement_service_pb2'
...
StopDIRequest = _reflection.GeneratedProtocolMessageType('StopDIRequest', (_message.Message,), {
  'DESCRIPTOR' : _STOPDIREQUEST,
  '__module__' : 'ctet_dio_measurement_service_pb2'
  # @@protoc_insertion_point(class_scope:measurementservice.StopDIRequest)
  })
_sym_db.RegisterMessage(StopDIRequest)

StopDIResponse = _reflection.GeneratedProtocolMessageType('StopDIResponse', (_message.Message,), {
  'DESCRIPTOR' : _STOPDIRESPONSE,
  '__module__' : 'ctet_dio_measurement_service_pb2'
  # @@protoc_insertion_point(class_scope:measurementservice.StopDIResponse)
  })
_sym_db.RegisterMessage(StopDIResponse)
...
_MEASUREMENTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='StopDI',
    full_name='measurementservice.MeasurementService.StopDI',
    index=6,
    containing_service=None,
    input_type=_STOPDIREQUEST,
    output_type=_STOPDIRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
